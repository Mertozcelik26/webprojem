      ...
      <div class="container">
        ...
        <div class="row gy-4" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-7" data-aos="fade-up" data-aos-delay="200">
            <div class="content">
                <br>
              <h3 style="text-align:center">Şirketimiz</h3>
              <br>
              <br>
              <ul>
                <li><i class="bi bi-check-circle-fill"></i> <span>Şirketimiz 1980'lerden beri hizmet vermektedir.</span></li>
                <li><i class="bi bi-check-circle-fill"></i> <span>Üstün kalite ve güler yüzlü hizmetimizle emrinizdeyiz.</span></li>
                <li><i class="bi bi-check-circle-fill"></i> <span>Aile şirketi olarak müşterilerimizi ailemiz olarak görür ve ona göre hizmet ederiz.</span></li>
              </ul>
            </div>
          </div>
        </div>
