...
<header id="header" class="header d-flex align-items-center fixed-top">
  ...
  <main class="main">
    ...
    <!-- Page Title -->
    <div class="page-title" data-aos="fade" style="background-image: url(assets/img/services-page-title-bg.jpg);">
      <div class="container">
        <h1>Services</h1>
        <nav class="breadcrumbs">
          <ol>
            <li><a href="index.php">Anasayfa</a></li>
            <li class="current">Servislerimiz</li>
          </ol>
        </nav>
      </div>
    </div><!-- End Page Title -->
        ...
        ?>
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <div class="card-item">
              <div class="row">
                <div class="col-xl-5">
                  <div class="card-bg"><img src="assets/img/services/<?= $servis["foto"] ?>" alt=""> </div>
                </div>
                <div class="col-xl-7 d-flex align-items-center">
                  <div class="card-body">
                    <h4 class="card-title"><?= $servis["baslik"] ?> </h4>
                    <p> <?= $servis["tanim"] ?> </p>
                  </div>
                </div>
              </div>
