  ...
  <main class="main">
    ...
    <section id="hero" class="hero section">
      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-4">
            <h1 data-aos="fade-up">Kompresör Dünyasının En İyisi</h1>
            <blockquote data-aos="fade-up" data-aos-delay="100">
                <p> Türkiye'nin en kaliteli kompresörleri ve en güzel servisini sağlıyoruz.</p>
            </blockquote>
